...
pub unsafe fn _export_run_cabi<T: Guest>(arg0: *mut u8) -> *mut u8 {
    ...
    match result68 {
        Ok(e) => {
            ...
            *ptr69.add(2 * ::core::mem::size_of::<*const u8>()).cast::<usize>() = len70;
            *ptr69.add(::core::mem::size_of::<*const u8>()).cast::<*mut u8>() = ptr70
                .cast_mut();
        }
        Err(e) => {
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:wavs:worker@0.3.0-beta:layer-trigger-world:encoded world"
)]
#[doc(hidden)]
