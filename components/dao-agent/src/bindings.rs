...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.31.0:wavs:worker@0.3.0-beta:layer-trigger-world:encoded world"]
#[doc(hidden)]
...
\0\x05trace\0\0\x04\0\x09log-level\x03\0!\x03\x01\"wavs:worker/layer-types@0.3.0\
-beta\x05\0\x02\x03\0\0\x0etrigger-action\x03\0\x0etrigger-action\x03\0\x01\x02\x03\
...
run\x01\x09\x04\x01*wavs:worker/layer-trigger-world@0.3.0-beta\x04\0\x0b\x19\x01\
